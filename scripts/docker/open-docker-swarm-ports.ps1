Write-Output "Opening Docker swarm mode ports"

if (!(Get-NetFirewallRule | Where-Object {$_.Name -eq "Dockerswarm2377"})) {
...
if (!(Get-NetFirewallRule | Where-Object {$_.Name -eq "Dockerswarm7946"})) {
...
if (!(Get-NetFirewallRule | Where-Object {$_.Name -eq "Dockerswarm7946udp"})) {
...
if (!(Get-NetFirewallRule | Where-Object {$_.Name -eq "Dockerswarm4789"})) {
